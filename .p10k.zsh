# Generated by Powerlevel10k configuration wizard on 2026-03-17 at 08:11 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_MODE='ComicCode Nerd Font SemiBold'
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%F{#6c7086}╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%F{#6c7086}├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{#6c7086}╰─'
  # Connect right prompt lines with these symbols.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%F{#6c7086}─╮'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%F{#6c7086}─┤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%F{#6c7086}─╯'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#11111b'
